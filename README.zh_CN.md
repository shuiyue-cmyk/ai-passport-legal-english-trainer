...
- 内置 **1,639 条**法律术语：14 章中英对照教材已标注术语，经去重、词典补注、非法律词削减、翻译复核，另有 227 条大学级难词扩充。
- **全词库离线发音**（Opus，约 1.9 MB 音频分区）。
- **两种学习方向**：英→中、中→英，另有学习单词与错词本。
- **学习单词/错词本是 4 选 1**：给英文选中文，学习按主章节锁死分批（20 个一批，
  批内打乱），答错隔 3 词重练直到答对；
  末行有**不认识**（记错亮答案）与**播放音频**。
- **复习**：学习/错词答对按 1/4 概率 30 学习分钟后到期重现（认→亮中文→四选一，答错回错词本）。
