...
主菜单六项：**英→中 / 中→英 / 拼写 / 混合练习 / 错词本 / 学习统计**。
...
屏上显示中文译名、首字母与字母数；用 ↑↓ 选字母、OK 确认逐个拼出英文单词。
...
拼写模式只包含纯字母单词（不含空格与连字符），其余词条自动跳过。
...
| 文件 | 职责 |
| --- | --- |
| `main/vocab_app.c` | LVGL 界面与按键分发（主菜单 / 卡片 / 拼写 / 统计） |
